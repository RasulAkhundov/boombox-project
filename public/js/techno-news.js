$(document).ready(async function() {
    ...
    .get(`${window.development}/api/get-techno-news?limit=${newsLimit}`)
    .then(res => res.data.allNews);

    //GETTING ALL NEWS LENGTH
    let allNews = await axios.get(`${window.development}/api/get-techno-news`).then(res => res.data.allNews);
    ...
    $("#load-more-btn").click(function() {
        ...
        setTimeout(async function() {
            ...
            await axios.get(`${window.development}/api/get-techno-news?limit=${newsLimit}`).then(res =>{
